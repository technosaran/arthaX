...
export function BinanceConnectCard() {
  const { status, isSaving, isSyncing, fetchStatus, saveCustomKeys, clearCustomKeys, syncHoldings } =
    useBinanceSettings();
          ...
          <div className="flex flex-wrap items-center gap-2">
            {status.configured && (
              <button
                onClick={handleSync}
                disabled={isSyncing}
                className="inline-flex items-center gap-2 rounded-lg bg-yellow-600 px-4 py-2 font-medium text-white text-xs shadow-md transition-all hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 active:scale-95 disabled:opacity-50"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-yellow-500/40 bg-yellow-500/10 px-3 py-2 font-medium text-yellow-300 text-xs transition-colors hover:bg-yellow-500/20"
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="rounded-lg bg-yellow-600 px-4 py-1.5 text-xs font-medium text-white hover:bg-yellow-500 disabled:opacity-50"
                  >
