...
const PREWARMED_LOGOS: Record<string, string> = {
  "sbi.co.in": "https://logo.clearbit.com/sbi.co.in?size=512",
  ...
  "chase.com": "https://upload.wikimedia.org/wikipedia/commons/7/7b/Chase_logo_2007.svg",
...
export function getFastLogoCandidateUrls(domain: string): string[] {
  ...
  candidates.push(
    ...
    // Engine 2: Brandfetch 512px Modern Brand Asset CDN
