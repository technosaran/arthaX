...
// Neutral default that avoids SSR/client mismatch
...
function subscribeHour(_callback: () => void) {
  return () => {};
}
...
export default function Greeting({
  ...
  const greetingInfo = useSyncExternalStore(
    subscribeHour,
    getClientGreeting,
    getServerGreeting
  );
    ...
    <div className="animate-fade-in space-y-3 select-none">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          {/* Main Title */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-normal tracking-tight leading-tight text-white flex flex-wrap items-center gap-3" suppressHydrationWarning>
